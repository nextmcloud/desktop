...
public slots:
    ...
    {
        auto *timerSlideShowObj = rootObj->findChild<QObject*>("timerSlideShow");
...
private slots:
    ...
    void testText()
    {
        ...
        auto *text = rootObj->findChild<QObject*>("titleText");
        ...
        QCOMPARE(font.pixelSize(), 10);             //Style.qml::property int topLinePixelSize: 10
    ...
    void testSwipeView()
    {
        ...
        auto *SwipeView = rootObj->findChild<QObject*>("swipeView");
    ...
    void testCancelButton()
    {
        ...
        auto *cancelButtonObj = rootObj->findChild<QObject*>("cancelButton");
        ...
        auto font = qvariant_cast<QFont>(var);
        QCOMPARE(font.family(), "Segoe UI"); //Style.qml::property string swipeFontFamily: "Segoe UI"
        QCOMPARE(font.pixelSize(), 10);      //Style.qml::property int topLinePixelSize: 10
