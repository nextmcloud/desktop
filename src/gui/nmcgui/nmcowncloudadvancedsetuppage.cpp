      ...
      _tLogoLbl(new QLabel(this))
{
    ...
    auto loginBrowserButton = new QPushButton(tr("LOGIN"), this);
    ...
    QLabel *magentaLabel = new QLabel(tr("MagentaCLOUD"), this);
    magentaLabel->setStyleSheet("QLabel{font-size: 15px; font-weight: bold;}");

    QLabel *descriptionLabel = new QLabel(tr("SETUP_HEADER_TEXT_2"), this);
