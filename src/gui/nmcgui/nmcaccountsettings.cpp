...
void NMCAccountSettings::setLayout()
{
    ...
    quota->setText(QCoreApplication::translate("", "USED_STORAGE_%1")
                       .arg(getUi()->quotaProgressBar->value() > 0 ? Utility::compactFormatDouble(getUi()->quotaProgressBar->value(), 1) : QString::Number(0)));
