...
Rectangle {
    id: welcomeForm
    width: firstPage.implicitWidth
    height: firstPage.implicitHeight
    focus: true
    color: Style.ncBlue
    Text {
        id: titleText
    ...
    SwipeView {
        ...
        Page {
            id: firstPage
            Image {
                source: "qrc:/theme/NMCswipe/page1.png"
        ...
        Page {
            Image {
                source: "qrc:/theme/NMCswipe/page2.png"
                sourceSize.width: 720
            }
        }
        ...
        Page {
            Image {
                source: "qrc:/theme/NMCswipe/page3.png"
                sourceSize.width: 720
            }
        }
    }
