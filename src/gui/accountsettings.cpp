...
void AccountSettings::customizeStyle()
{
   ...
   // _ui->connectLabel->setText(msg);
    ...
    _ui->moreMemoryButton->setPalette(QGuiApplication::palette());
    _ui->moreMemoryButton->setStyleSheet("QPushButton {height : 24px ; font : 13px; border: 2px solid #CCCCCC; backgroud:#E1E1E1}");
}
