...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OCC__SslButton_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject OCC::SslButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QToolButton::staticMetaObject>(),
    qt_meta_stringdata_OCC__SslButton.data,
    qt_meta_data_OCC__SslButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *OCC::SslButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OCC__SslButton.stringdata0))
