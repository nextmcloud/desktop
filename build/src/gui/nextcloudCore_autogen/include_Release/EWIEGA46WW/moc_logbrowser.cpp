...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OCC__LogBrowser_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(1, 16, 22), // "togglePermanentLogging"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 7) // "enabled"

    },
    "OCC::LogBrowser\0togglePermanentLogging\0"
    "\0enabled"
};
...
void OCC::LogBrowser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->togglePermanentLogging((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject OCC::LogBrowser::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_OCC__LogBrowser.data,
    qt_meta_data_OCC__LogBrowser,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *OCC::LogBrowser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OCC__LogBrowser.stringdata0))
