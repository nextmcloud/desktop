...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OCC__OwncloudConnectionMethodDialog_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject OCC::OwncloudConnectionMethodDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_OCC__OwncloudConnectionMethodDialog.data,
    qt_meta_data_OCC__OwncloudConnectionMethodDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *OCC::OwncloudConnectionMethodDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OCC__OwncloudConnectionMethodDialog.stringdata0))
