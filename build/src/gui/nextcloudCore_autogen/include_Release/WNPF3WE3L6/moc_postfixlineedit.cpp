...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OCC__PostfixLineEdit_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject OCC::PostfixLineEdit::staticMetaObject = { {
    QMetaObject::SuperData::link<QLineEdit::staticMetaObject>(),
    qt_meta_stringdata_OCC__PostfixLineEdit.data,
    qt_meta_data_OCC__PostfixLineEdit,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *OCC::PostfixLineEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OCC__PostfixLineEdit.stringdata0))
